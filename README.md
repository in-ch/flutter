...
- 채팅앱 만들기 part1&2 
 1. rich text : RichText 위젯은 다양한 스타일을 사용하는 텍스트를 표시하는 데 사용됩니다 . 표시된 텍스트는 TextSpan 개체 트리를 사용하여 설명되며, 각 개체에는 해당 하위 트리 에 사용되는 고유한 관련 스타일이 있습니다 . 레이아웃 제약 조건에 따라 텍스트가 여러 줄에 걸쳐 표시되거나 모두 같은 줄에 표시될 수 있습니다.
 2. 사망 연산자 -> 삼항 연산자였다 ㅋㅋㄹㅃㅃ  조건 ? true 일 때 : false 일 때 
 3. flutter는 box-shadow넣는 게 매우 간편하다.  